...
<body onload="focuspwd()">
	...
	<div class="content">
		<div class="left">
			<a href="modifyPassword.jsp" target="_self">修改密码</a><br>
			<br> <a href="modifyDetail.jsp" " target="_self">修改个人信息</a><br>
			<br> <a href="index.jsp" target="_self">选购花品</a><br>
		</div>
		<div class="right">
			<div style="padding-left:200px;width: 600px;">
				<s:form name="form1" onsubmit="return modpwd()"
					action="updateUserPassword.action" method="post">
					<tr>
						<td>
