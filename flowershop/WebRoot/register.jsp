...
<!--
	...
	-->
<script type="text/javascript" src="js/reg.js"
	...
	<div class="content">
		...
		<div class="right">
			<div style="padding-left:200px;width: 600px;">
				<s:form name="form2" onsubmit="return modpwdr()" action="addUser.action"
					 method="post">
					 <tr>
						<td>
						<td><s:property value="#request.msg" /></td>
					</tr>
					<s:textfield label="用户名" name="user.username" value=""></s:textfield>
					...
					<s:radio label="性别" list="#{1:'男',0:'女'}" value="0"
						name="userdetail.xb"></s:radio>
					<tr>
						<td></td>
						<td><ss:datetimepicker label="出生日期" name="userdetail.csrq"></ss:datetimepicker>
						</td>
					</tr>
